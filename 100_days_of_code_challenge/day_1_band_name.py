...
choice = input("Type p for personalized results or r for random-generator. Hit enter after you type the letter: ")
flag = False
...
while (flag):
    if (choice == "p"):
        ...
        #Present the info
        print("\n\nYour ideal band name is: " + hometown + " " + pet_name + "!")
...
def random_city_generator():
    ...
    print(random.choice(city_names))